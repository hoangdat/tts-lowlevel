...
public class AudioSynth01 extends JFrame {
    ...
    float sampleRate = 16000.0F;  //Allowable 8000,11025,16000,22050,44100
    ...
    //A buffer to hold two seconds monaural and one second stereo data at
    //16000 samp/sec for 16-bit samples
    ...
    //Following radio buttons select a synthetic data type.  Add more buttons if you add
    // more synthetic data types.  They appear in the center position of the GUI.
    ...
    //Following components appear in the South position of the GUI.
    ...
    public AudioSynth01() {//constructor
        ...
        //This panel is used for cosmetic purposes only, to cause the radio buttons to be
        // centered horizontally in the Center position.
        ...
        //Disable the Play button initially to force the user to generate some data before
        // trying to listen to it or write it to a file.
        ...
        generateBtn.addActionListener(
                new ActionListener() {
                    public void actionPerformed(
                            ActionEvent e) {  //Don't allow Play during generation
                        playOrFileBtn.setEnabled(false);
